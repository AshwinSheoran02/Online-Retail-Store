...
// 	include("functions.php");
    ...
    if( !empty($_GET["dopaytm"]))
        ...
        //if( !$user_data['PhoneNumber'] )
          ...
          //echo "  \n  ";
          $addtocart = "insert into payment(Payment_Type , PhoneNumber , Order_ID ) values('Paytm' , '$userphone' , $oid ); ";
...
<body>
    <img src="./assets/paytmlogo.png"  height = "200" width="600"/>
    <hr>
    <h1>Pay through Paytm</h1>
    <hr>
    ...
    <input type="text" name = "PhoneNumber"placeholder="Enter Phone Number">
            <br><br>
            Paytm Password
            <input type="password" name = "password"placeholder=" Enter Paytm Password">
            <br><br>
            The amount to be paid
            <input disabled type="amount" name = "amount"placeholder="Paytm amount" value = "<?=$p = $ocost ?>" >
            <br><br>
            Pay from you paytm account
            <br>
